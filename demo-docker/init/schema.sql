...
VALUES 
    ('sustainable-economy', 'Modelling optimal lockdowns with waning immunity', 'Goenka, A., Liu, L., & Nguyen, M.-H. (2022)', 'Modelling optimal lockdowns with waning immunity. Economic Theory. https://doi.org/10.1007/s00199-022-01468-8', 'https://doi.org/10.1007/s00199-022-01468-8', ''),
    ...
    ('climate-change', 'Quality of Life and Climate Change: Evidence from the SHARE Dataset', 'Luong, T. A., & Nguyen, M. H. (2022)', 'Quality of Life and Climate Change: Evidence from the SHARE Dataset. Available at SSRN 4091827.', '', ''),
    ...
    ('health', 'Modeling optimal quarantines with waning immunity', 'Goenka, A., Liu, L., & Nguyen, M.-H. (2021b, May)', 'Modeling optimal quarantines with waning immunity [Monograph]. TSE Working Paper.', 'http://tse-fr.eu/pub/125549', ''),
    ...
    ('health', 'Does the Covid-19 pandemic disproportionately affect the poor? Evidence from a six-country survey', 'Dang, H.-A., Huynh, T. L. D., & Nguyen, M.-H. (2020)', 'Does the Covid-19 Pandemic Disproportionately Affect the Poor? Evidence from a Six-Country Survey (SSRN Scholarly Paper No. 3627054).', 'https://doi.org/10.2139/ssrn.3627054', ''),

...
async function getResearchPapers(): Promise<ResearchPaper[]> {
  try {
    ...
    const result = await client.query(
      "SELECT * FROM research_paper WHERE fields LIKE '%agriculture%' ORDER BY id"
    )
    client.release()
    return result.rows
  } catch (error) {
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-16 text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-4 tracking-tight">
              Agriculture & Soil Science Research
            </h1>
            <p className="text-foreground/70 text-lg max-w-3xl mx-auto">
              Explore our research publications on sustainable agriculture, soil enhancement, and biochar applications for improved crop yields and environmental remediation.
            </p>
          </div>

...
async function getResearchPapers(): Promise<ResearchPaper[]> {
  try {
    ...
    const result = await client.query(
      "SELECT * FROM research_paper WHERE fields LIKE '%energy%' ORDER BY id"
    )
    client.release()
    return result.rows
  } catch (error) {
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-16 text-center">
            ...
            <p className="text-foreground/70 text-lg max-w-3xl mx-auto">
              Explore our research publications on energy economics, renewable energy, and sustainable energy systems.
            </p>
          </div>
